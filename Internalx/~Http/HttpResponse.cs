...
namespace Shadynet.Http
{
    ...
    public sealed class HttpResponse
    {
        ...
        /// </summary>
        /// <value>Encoding the message body if appropriate response specified, otherwise the value specified in <see cref="Shadynet.Http.HttpException"/>. If it is not specified, then the value <see cref="System.Text.Encoding.Default"/>.</value>
        ...
        /// <summary>
        /// Returns the cookies generated by the query, or set in <see cref="Shadynet.Http.HttpException"/>.
        /// </summary>
        /// <remarks>If cookies are set to <see cref="Shadynet.Http.HttpException"/> and the value of the <see cref="Shadynet.Http.CookieCore.IsLocked"/> equally <see langword="true"/>, the new cookie will be created.</remarks>
